...
Make sure `Git` cli can access `GitHub.com` or your GitHub Enterprise Server.
...
### 2. SSL certificate related issue
  ...
  If you are seeing `SSL Certificate problem:` in the log, it means the `git` can't connect to GitHub server due to SSL handshake failure.
